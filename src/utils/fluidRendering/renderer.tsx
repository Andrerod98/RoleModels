...
export async function renderFluidDataObjects(
  ...
  return new Promise(async (resolve, reject) => {
    ...
    return await renderFluidObjectsDivs(
      props,
      dataObject1,
      dataObject2,
      resolve
...
async function createDomView(
  ...
  const leftFluidObject = new props.view(dataObject1, divs.div1, "Left");
  leftFluidObject.render();
  const rightFluidObject = new props.view(dataObject2, divs.div2, "Right");
  rightFluidObject.render();
  return resolve(divs.containerDiv);
}

async function createReactView(
  props: FluidLoaderProps,
  dataObject1: IFluidObject,
  dataObject2: IFluidObject,
  divs: any,
  ...
  ReactDOM.render(
    <props.view model={dataObject1} {...props} sbs={"left"} />,
    divs.div1
  );
  ReactDOM.render(
    <props.view model={dataObject2} {...props} sbs={"right"} />,
    divs.div2
  );
  return resolve(divs.containerDiv);
}

async function renderFluidObject(
  dataObject: IFluidObject,
  div: HTMLDivElement
) {
