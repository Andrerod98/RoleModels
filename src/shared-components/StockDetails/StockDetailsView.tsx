...
import { StockDetailsController } from "./StockDetailsController";
...
export function StockDetailsView({
  controller,
}: {
  controller: StockDetailsController;
}) {
  const { value, ...component } = controller.get() as StockDetailsModel;
