...
import { PrototypingToolInstantiationFactory } from "./PrototypingToolDataObject";
 ...
 * components.
 */
export const PrototypingToolContainerFactory = new ContainerRuntimeFactoryWithDefaultDataStore(
